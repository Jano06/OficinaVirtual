<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/MenuPrincipal.master" CodeFile="EditaProspecto.aspx.cs" Inherits="views_EditaProspecto" %>
    ...
    <table class="tabla">
       ...
       <tr>
        ...
        <tr>
            ...
            <td class="style14">
                <asp:TextBox ID="txtRefCasa" runat="server" TextMode="MultiLine" Width="338px" Height="50px" style="resize: false;" /></td>
        </tr>
        <tr>
            <td class="style7" colspan="3">
                </td>
       ...
       <tr>
         ...
         <tr>
            ...
            <td class="style14">
                <asp:TextBox ID="txtRefPaq" runat="server" TextMode="MultiLine" Width="338px" Height="50px" style="resize: false;" /></td>
        </tr>
        <tr>

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/MenuPrincipal.master" CodeFile="CompraInscripcionDetalle.aspx.cs" Inherits="views_CompraInscripcionDetalle" %>
        ...
        <table class="subtitulo">
            <tr>
                <td colspan="2" class="style2">
                    <asp:Label ID="lblTitulo" runat="server" Text="Verifica datos del prospecto y selecciona el modo de entrega" Font-Bold="true" />
                </td>
            </tr>
            <%--<tr>
                    ...
                    <asp:Panel ID="pnlDetalleCompra" runat="server" Visible="false">
                        <asp:Table ID="tblDetalleCompra" runat="server" Width="809px">
                            <asp:TableRow>
                                ...
                                <asp:TableCell>
                                    <asp:Label ID="lblCantInscr" runat="server" Text="1" />
                                </asp:TableCell><asp:TableCell>
                                    <asp:Label ID="lblInscripcion" runat="server" />
                                </asp:TableCell><asp:TableCell>
                                    <asp:Label ID="lblPUnitInscr" runat="server" />
                                </asp:TableCell><asp:TableCell>
                                    <asp:Label ID="lblPMontoInscr" runat="server" Text="$" />
                                </asp:TableCell><asp:TableCell HorizontalAlign="Right">
                                    <asp:Label ID="lblMontoInscr" runat="server" />
                                </asp:TableCell></asp:TableRow><asp:TableRow HorizontalAlign="Center">
                                <asp:TableCell>
